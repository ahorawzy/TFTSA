...
ggsave("D:\\王致远\\论文\\大论文\\实验\\绘图\\原始欧式分层.jpg",width=7.29,height=4.5,dpi=600)
```
...
rownames(tmlkmedoid) <- c("第1类簇中心点","第2类簇中心点")
#tmltemp <- rbind(tmlkmeans,tmlzz)
...
ggplot(tmltotal,aes(tmltotal$时间序号,tmltotal$机动车当量,group=tmltotal$日期,color=tmltotal$层次聚类结果))+
  ...
  scale_x_continuous(breaks = seq(0,288,24),limits = c(0,288))+
  scale_y_continuous(breaks = seq(0,120,20))
ggsave("D:\\王致远\\论文\\大论文\\实验\\绘图\\原始欧式K中心点.jpg",width=7.29,height=4.5,dpi=600)
```
